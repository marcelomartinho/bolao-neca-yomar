...
-- Rodada 1
  ...
  ('00000000-0000-4000-8000-0000000000a7',  6, 'X'),  -- BRA x MAR  (gigantes #6 x #7 — parelho)
...
-- Rodada 3
  ...
  ('00000000-0000-4000-8000-0000000000a7', 63, '2'),  -- CPV x KSA  (Arábia > Cabo Verde)
  ...
  ('00000000-0000-4000-8000-0000000000a7', 71, 'X'),  -- ALG x AUT  (Argélia x Áustria — parelho)
