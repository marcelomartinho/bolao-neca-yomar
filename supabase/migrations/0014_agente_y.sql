...
-- Rodada 1
  ...
  ('00000000-0000-4000-8000-0000000000a7',  8, 'X'),  -- AUS x TUR  (parelho #27 x #22 — 50/50)
...
-- Rodada 3
  ...
  ('00000000-0000-4000-8000-0000000000a7', 50, 'X'),  -- BIH x QAT  (ambos fracos e em forma ruim — parelho)
  ...
  ('00000000-0000-4000-8000-0000000000a7', 59, 'X'),  -- TUR x USA  (EUA casa x Turquia — parelho)
  ...
  ('00000000-0000-4000-8000-0000000000a7', 69, 'X'),  -- COL x POR  (#13 x #5 na R3 — parelho)
